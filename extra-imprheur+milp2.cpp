...
int main()
{
	try
	{
		...
		ofstream myfile("myfile_lambda=0.txt");
		...
		//for (int i = 2; i < 3; ++i)
		{
			...
			switch (i)
			{
			case 0: //low //sys2-old sys1
			{
				//sys1 //least load //m3_slaS_tau10068_pi720_v0.2
			...
			case 3:
			{
				//sys4  //medium //sys4-old sys2
				SLAdaily = new int[24]{96, 96, 96, 96, 96, 96, 74, 74, 74, 74, 74, 74, 90, 90, 90, 90, 90, 90, 0, 0, 0, 0, 0, 0};
				pathparent = "C:\\Users\\hp\\Desktop\\tez\\cplex tez\\19.02.2016-Ogleden sonra\\Yeni klasör\\runs\\medium\\pseudo\\cor\\real\\";
				m = 2;
			}
